...
use waecan_core::error::CoreError;
use waecan_core::transaction::Transaction;
use waecan_core::validation::validate_transaction;
...
mod tests {
    ...
    use waecan_core::transaction::{TransactionInput, TransactionOutput, MIN_FEE_ATOMIC};
